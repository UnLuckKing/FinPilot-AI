# FinPilot Multi-Market v2.1 — Kurulum
...
2. Trend devamı, geri çekilme, kırılım teyidi ve yatay piyasa dönüşü modellerinin ayrı backtesti
3. EMA trendi, RSI, MACD, ATR, kırılım ve hacim
4. Komisyon ve fiyat kayması içeren geçmiş simülasyon
5. Küçük örneklem için yumuşatılmış kazanma oranı ve `%95` aralık
6. Zaman sırası korunmuş eğitim/test ayrımlı yerel lojistik model
7. Benzer geçmiş dönemlerden üç vadeli yön olasılığı ve beklenen aralık
8. Yakın dönem performansı ve 250 senaryolu stres testi
9. Piyasa özel temel/KAP veya likidite/BTC kapıları
10. Destek, EMA ve ATR tabanlı üç emir planından fiyat adımına uygun seçim

| Etiket | Anlamı |
| --- | --- |
| **YATIR** | O taramadaki tüm zorunlu kapılar geçti. Yine de kazanç garantisi değildir. |
| **YATIRMA** | En az bir kapı geçmedi veya doğrulanamadı. Kart “Neden YATIRMA?” alanında gerçekleşen değerleri ve gerekli eşikleri gösterir. |
...
Aynı piyasa-strateji çiftinde en az 12 sonuç izlendikten sonra hedef oranı `%40`ın veya ortalama sonuç `0R`ın altına inerse performans koruması o modelin yeni `YATIR` üretmesini durdurur. Bu kayıtlar yalnızca tarama fiyatlarıyla ölçüldüğünden gerçek işlem geçmişi sayılmaz.
